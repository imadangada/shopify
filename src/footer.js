...
const navigation = {
  solutions: [
    ...
    { name: 'Partner Offers', href: '#' },
    { name: 'Store Examples', href: '#' },
  ],
  support: [
    { name: 'Leaders', href: '#' },
    { name: 'About Us', href: '#' },
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-white tracking-wider uppercase">Resource</h3>
                <ul role="list" className="mt-4 space-y-4">
        ...
        <p className="mt-20 text-base text-white xl:text-center">&copy; 2022 Shopify. All rights reserved.</p>
